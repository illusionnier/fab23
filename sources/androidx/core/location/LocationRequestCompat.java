...
public final class LocationRequestCompat {
    ...
    public LocationRequest toLocationRequest(String provider) {
        ...
        try {
            ...
            LocationRequest request = (LocationRequest) sCreateFromDeprecatedProviderMethod.invoke((Object) null, new Object[]{provider, Long.valueOf(this.mIntervalMillis), Float.valueOf(this.mMinUpdateDistanceMeters), false});
            if (request == null) {
                return null;
            }
            ...
            sSetQualityMethod.invoke(request, new Object[]{Integer.valueOf(this.mQuality)});
            if (getMinUpdateIntervalMillis() != this.mIntervalMillis) {
                ...
                sSetFastestIntervalMethod.invoke(request, new Object[]{Long.valueOf(this.mMinUpdateIntervalMillis)});
            }
            if (this.mMaxUpdates < Integer.MAX_VALUE) {
                ...
                sSetNumUpdatesMethod.invoke(request, new Object[]{Integer.valueOf(this.mMaxUpdates)});
            }
            if (this.mDurationMillis < PASSIVE_INTERVAL) {
                ...
                sSetExpireInMethod.invoke(request, new Object[]{Long.valueOf(this.mDurationMillis)});
            }
            return request;
