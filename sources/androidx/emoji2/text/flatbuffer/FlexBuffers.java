...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        public String asString() {
            if (isString()) {
                ...
                return this.bb.getString(start, (int) FlexBuffers.readUInt(readBuf, start - i, i));
            } else if (isKey() == 0) {
                return "";
            } else {
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int index) {
            ...
            int packedType = Unsigned.byteToUnsignedInt(this.bb.get((int) (((long) this.end) + (((long) this.byteWidth) * len) + ((long) index))));
            return new Reference(this.bb, this.end + (this.byteWidth * index), this.byteWidth, packedType);
        }
    }
