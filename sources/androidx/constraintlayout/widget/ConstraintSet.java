...
public class ConstraintSet {
    ...
    public void load(android.content.Context r11, org.xmlpull.v1.XmlPullParser r12) {
        /*
            ...
            r0 = 0
            r1 = 0
            int r2 = r12.getEventType()     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
        L_0x0006:
            r3 = 1
            ...
            }     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
        L_0x0010:
            goto L_0x01d1
        L_0x0012:
            java.lang.String r8 = r12.getName()     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r0 = r8
            java.util.Locale r8 = java.util.Locale.ROOT     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            java.lang.String r8 = r0.toLowerCase(r8)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            int r9 = r8.hashCode()     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            switch(r9) {
        ...
        L_0x0025:
            ...
            boolean r3 = r8.equals(r3)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
        ...
        L_0x0039:
            ...
            boolean r4 = r8.equals(r4)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
        ...
        L_0x0050:
            goto L_0x005f
        L_0x0051:
            java.util.HashMap<java.lang.Integer, androidx.constraintlayout.widget.ConstraintSet$Constraint> r3 = r10.mConstraints     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            int r4 = r1.mViewId     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            java.lang.Integer r4 = java.lang.Integer.valueOf(r4)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r3.put(r4, r1)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r1 = 0
            goto L_0x005f
        L_0x005e:
            return
        ...
        L_0x0062:
            java.lang.String r8 = r12.getName()     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r0 = r8
            int r8 = r0.hashCode()     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            switch(r8) {
        ...
        L_0x0070:
            java.lang.String r4 = "Constraint"
            boolean r4 = r0.equals(r4)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
        ...
        L_0x0086:
            ...
            boolean r5 = r0.equals(r5)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
        ...
        L_0x00de:
            ...
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r3 = r1.mCustomConstraints     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            androidx.constraintlayout.widget.ConstraintAttribute.parse(r11, r12, r3)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            goto L_0x01cb
        L_0x00e7:
            java.lang.RuntimeException r3 = new java.lang.RuntimeException     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r4.<init>()     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r4.append(r5)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            int r5 = r12.getLineNumber()     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r4.append(r5)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            java.lang.String r4 = r4.toString()     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r3.<init>(r4)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            throw r3     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
        L_0x0100:
            if (r1 == 0) goto L_0x010d
            androidx.constraintlayout.widget.ConstraintSet$Motion r3 = r1.motion     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r3.fillFromAttributeList(r11, r4)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            goto L_0x01cb
        L_0x010d:
            java.lang.RuntimeException r3 = new java.lang.RuntimeException     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
        ...
        L_0x0126:
            ...
            androidx.constraintlayout.widget.ConstraintSet$Layout r3 = r1.layout     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r3.fillFromAttributeList(r11, r4)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            goto L_0x01cb
        L_0x0133:
        ...
        L_0x014c:
            ...
            androidx.constraintlayout.widget.ConstraintSet$Transform r3 = r1.transform     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r3.fillFromAttributeList(r11, r4)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            goto L_0x01cb
        L_0x0159:
        ...
        L_0x0172:
            ...
            androidx.constraintlayout.widget.ConstraintSet$PropertySet r3 = r1.propertySet     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r3.fillFromAttributeList(r11, r4)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            goto L_0x01cb
        L_0x017e:
        ...
        L_0x0197:
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r4 = r10.fillFromAttributeList(r11, r4, r7)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r1 = r4
            androidx.constraintlayout.widget.ConstraintSet$Layout r4 = r1.layout     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r4.mHelperType = r3     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            goto L_0x01cb
        L_0x01a5:
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r4 = r10.fillFromAttributeList(r11, r4, r7)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r1 = r4
            androidx.constraintlayout.widget.ConstraintSet$Layout r4 = r1.layout     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r4.mIsGuideline = r3     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            androidx.constraintlayout.widget.ConstraintSet$Layout r4 = r1.layout     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r4.mApply = r3     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            goto L_0x01cb
        L_0x01b7:
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r3 = r10.fillFromAttributeList(r11, r4, r3)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r1 = r3
            goto L_0x01cb
        L_0x01c1:
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r3 = r10.fillFromAttributeList(r11, r3, r7)     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r1 = r3
        L_0x01cb:
            goto L_0x01d1
        L_0x01cc:
            java.lang.String r3 = r12.getName()     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
        L_0x01d1:
            int r3 = r12.next()     // Catch:{ XmlPullParserException -> 0x01de, IOException -> 0x01d9 }
            r2 = r3
            goto L_0x0006
        L_0x01d8:
            goto L_0x01e2
    ...
    private void populateConstraint(Context ctx, Constraint c, TypedArray a, boolean override) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            switch (mapToConstant.get(attr)) {
                case 1:
                    constraint.layout.baselineToBaseline = lookupID(typedArray, attr, constraint.layout.baselineToBaseline);
                    break;
                case 2:
                    constraint.layout.bottomMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.bottomMargin);
                    break;
                case 3:
                    constraint.layout.bottomToBottom = lookupID(typedArray, attr, constraint.layout.bottomToBottom);
                    break;
                case 4:
                    constraint.layout.bottomToTop = lookupID(typedArray, attr, constraint.layout.bottomToTop);
                    break;
                case 5:
                    constraint.layout.dimensionRatio = typedArray.getString(attr);
                    break;
                case 6:
                    constraint.layout.editorAbsoluteX = typedArray.getDimensionPixelOffset(attr, constraint.layout.editorAbsoluteX);
                    break;
                case 7:
                    constraint.layout.editorAbsoluteY = typedArray.getDimensionPixelOffset(attr, constraint.layout.editorAbsoluteY);
                    break;
                case 8:
                    if (Build.VERSION.SDK_INT < 17) {
                        break;
                    } else {
                        constraint.layout.endMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.endMargin);
                        break;
                    }
                case 9:
                    constraint.layout.endToEnd = lookupID(typedArray, attr, constraint.layout.endToEnd);
                    break;
                case 10:
                    constraint.layout.endToStart = lookupID(typedArray, attr, constraint.layout.endToStart);
                    break;
                case 11:
                    constraint.layout.goneBottomMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.goneBottomMargin);
                    break;
                case 12:
                    constraint.layout.goneEndMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.goneEndMargin);
                    break;
                case 13:
                    constraint.layout.goneLeftMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.goneLeftMargin);
                    break;
                case 14:
                    constraint.layout.goneRightMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.goneRightMargin);
                    break;
                case 15:
                    constraint.layout.goneStartMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.goneStartMargin);
                    break;
                case 16:
                    constraint.layout.goneTopMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.goneTopMargin);
                    break;
                case 17:
                    constraint.layout.guideBegin = typedArray.getDimensionPixelOffset(attr, constraint.layout.guideBegin);
                    break;
                case 18:
                    constraint.layout.guideEnd = typedArray.getDimensionPixelOffset(attr, constraint.layout.guideEnd);
                    break;
                case 19:
                    constraint.layout.guidePercent = typedArray.getFloat(attr, constraint.layout.guidePercent);
                    break;
                case 20:
                    constraint.layout.horizontalBias = typedArray.getFloat(attr, constraint.layout.horizontalBias);
                    break;
                case 21:
                    constraint.layout.mHeight = typedArray.getLayoutDimension(attr, constraint.layout.mHeight);
                    break;
                case 22:
                    constraint.propertySet.visibility = typedArray.getInt(attr, constraint.propertySet.visibility);
                    constraint.propertySet.visibility = VISIBILITY_FLAGS[constraint.propertySet.visibility];
                    break;
                case 23:
                    constraint.layout.mWidth = typedArray.getLayoutDimension(attr, constraint.layout.mWidth);
                    break;
                case 24:
                    constraint.layout.leftMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.leftMargin);
                    break;
                case 25:
                    constraint.layout.leftToLeft = lookupID(typedArray, attr, constraint.layout.leftToLeft);
                    break;
                case 26:
                    constraint.layout.leftToRight = lookupID(typedArray, attr, constraint.layout.leftToRight);
                    break;
                case 27:
                    constraint.layout.orientation = typedArray.getInt(attr, constraint.layout.orientation);
                    break;
                case 28:
                    constraint.layout.rightMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.rightMargin);
                    break;
                case 29:
                    constraint.layout.rightToLeft = lookupID(typedArray, attr, constraint.layout.rightToLeft);
                    break;
                case 30:
                    constraint.layout.rightToRight = lookupID(typedArray, attr, constraint.layout.rightToRight);
                    break;
                case 31:
                    if (Build.VERSION.SDK_INT < 17) {
                        break;
                    } else {
                        constraint.layout.startMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.startMargin);
                        break;
                    }
                case 32:
                    constraint.layout.startToEnd = lookupID(typedArray, attr, constraint.layout.startToEnd);
                    break;
                case 33:
                    constraint.layout.startToStart = lookupID(typedArray, attr, constraint.layout.startToStart);
                    break;
                case 34:
                    constraint.layout.topMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.topMargin);
                    break;
                case 35:
                    constraint.layout.topToBottom = lookupID(typedArray, attr, constraint.layout.topToBottom);
                    break;
                case 36:
                    constraint.layout.topToTop = lookupID(typedArray, attr, constraint.layout.topToTop);
                    break;
                case 37:
                    constraint.layout.verticalBias = typedArray.getFloat(attr, constraint.layout.verticalBias);
                    break;
                case 38:
                    constraint.mViewId = typedArray.getResourceId(attr, constraint.mViewId);
                    break;
                case 39:
                    constraint.layout.horizontalWeight = typedArray.getFloat(attr, constraint.layout.horizontalWeight);
                    break;
                case 40:
                    constraint.layout.verticalWeight = typedArray.getFloat(attr, constraint.layout.verticalWeight);
                    break;
                case 41:
                    constraint.layout.horizontalChainStyle = typedArray.getInt(attr, constraint.layout.horizontalChainStyle);
                    break;
                case 42:
                    constraint.layout.verticalChainStyle = typedArray.getInt(attr, constraint.layout.verticalChainStyle);
                    break;
                case 43:
                    constraint.propertySet.alpha = typedArray.getFloat(attr, constraint.propertySet.alpha);
                    break;
                case 44:
                    if (Build.VERSION.SDK_INT < 21) {
                        break;
                        ...
                        constraint.transform.elevation = typedArray.getDimension(attr, constraint.transform.elevation);
                        break;
                    }
                case 45:
                    constraint.transform.rotationX = typedArray.getFloat(attr, constraint.transform.rotationX);
                    break;
                case 46:
                    constraint.transform.rotationY = typedArray.getFloat(attr, constraint.transform.rotationY);
                    break;
                case 47:
                    constraint.transform.scaleX = typedArray.getFloat(attr, constraint.transform.scaleX);
                    break;
                case 48:
                    constraint.transform.scaleY = typedArray.getFloat(attr, constraint.transform.scaleY);
                    break;
                case 49:
                    constraint.transform.transformPivotX = typedArray.getDimension(attr, constraint.transform.transformPivotX);
                    break;
                case 50:
                    constraint.transform.transformPivotY = typedArray.getDimension(attr, constraint.transform.transformPivotY);
                    break;
                case 51:
                    constraint.transform.translationX = typedArray.getDimension(attr, constraint.transform.translationX);
                    break;
                case 52:
                    constraint.transform.translationY = typedArray.getDimension(attr, constraint.transform.translationY);
                    break;
                case 53:
                    if (Build.VERSION.SDK_INT < 21) {
                        break;
                    } else {
                        constraint.transform.translationZ = typedArray.getDimension(attr, constraint.transform.translationZ);
                        break;
                    }
                case 54:
                    constraint.layout.widthDefault = typedArray.getInt(attr, constraint.layout.widthDefault);
                    break;
                case 55:
                    constraint.layout.heightDefault = typedArray.getInt(attr, constraint.layout.heightDefault);
                    break;
                case 56:
                    constraint.layout.widthMax = typedArray.getDimensionPixelSize(attr, constraint.layout.widthMax);
                    break;
                case 57:
                    constraint.layout.heightMax = typedArray.getDimensionPixelSize(attr, constraint.layout.heightMax);
                    break;
                case 58:
                    constraint.layout.widthMin = typedArray.getDimensionPixelSize(attr, constraint.layout.widthMin);
                    break;
                case 59:
                    constraint.layout.heightMin = typedArray.getDimensionPixelSize(attr, constraint.layout.heightMin);
                    break;
                case 60:
                    constraint.transform.rotation = typedArray.getFloat(attr, constraint.transform.rotation);
                    break;
                case 61:
                    constraint.layout.circleConstraint = lookupID(typedArray, attr, constraint.layout.circleConstraint);
                    break;
                case 62:
                    constraint.layout.circleRadius = typedArray.getDimensionPixelSize(attr, constraint.layout.circleRadius);
                    break;
                case 63:
                    constraint.layout.circleAngle = typedArray.getFloat(attr, constraint.layout.circleAngle);
                    break;
                case 64:
                    constraint.motion.mAnimateRelativeTo = lookupID(typedArray, attr, constraint.motion.mAnimateRelativeTo);
                    break;
                case 65:
                    if (typedArray.peekValue(attr).type != 3) {
                        constraint.motion.mTransitionEasing = Easing.NAMED_EASING[typedArray.getInteger(attr, 0)];
                        break;
                    } else {
                        constraint.motion.mTransitionEasing = typedArray.getString(attr);
                        break;
                    }
                case 66:
                    constraint.motion.mDrawPath = typedArray.getInt(attr, 0);
                    break;
                case 67:
                    constraint.motion.mPathRotate = typedArray.getFloat(attr, constraint.motion.mPathRotate);
                    break;
                case 68:
                    constraint.propertySet.mProgress = typedArray.getFloat(attr, constraint.propertySet.mProgress);
                    break;
                case 69:
                    constraint.layout.widthPercent = typedArray.getFloat(attr, 1.0f);
                    break;
                case 70:
                    constraint.layout.heightPercent = typedArray.getFloat(attr, 1.0f);
                    break;
                case 71:
                    Log.e(TAG, "CURRENTLY UNSUPPORTED");
                    break;
                case 72:
                    constraint.layout.mBarrierDirection = typedArray.getInt(attr, constraint.layout.mBarrierDirection);
                    break;
                case 73:
                    constraint.layout.mBarrierMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.mBarrierMargin);
                    break;
                case 74:
                    constraint.layout.mReferenceIdString = typedArray.getString(attr);
                    break;
                case 75:
                    constraint.layout.mBarrierAllowsGoneWidgets = typedArray.getBoolean(attr, constraint.layout.mBarrierAllowsGoneWidgets);
                    break;
                case 76:
                    constraint.motion.mPathMotionArc = typedArray.getInt(attr, constraint.motion.mPathMotionArc);
                    break;
                case 77:
                    constraint.layout.mConstraintTag = typedArray.getString(attr);
                    break;
                case 78:
                    constraint.propertySet.mVisibilityMode = typedArray.getInt(attr, constraint.propertySet.mVisibilityMode);
                    break;
                case 79:
                    constraint.motion.mMotionStagger = typedArray.getFloat(attr, constraint.motion.mMotionStagger);
                    break;
                case 80:
                    constraint.layout.constrainedWidth = typedArray.getBoolean(attr, constraint.layout.constrainedWidth);
                    break;
                case 81:
                    constraint.layout.constrainedHeight = typedArray.getBoolean(attr, constraint.layout.constrainedHeight);
                    break;
                case 82:
                    constraint.motion.mAnimateCircleAngleTo = typedArray.getInteger(attr, constraint.motion.mAnimateCircleAngleTo);
                    break;
                case 83:
                    constraint.transform.transformPivotTarget = lookupID(typedArray, attr, constraint.transform.transformPivotTarget);
                    break;
                case 84:
                    constraint.motion.mQuantizeMotionSteps = typedArray.getInteger(attr, constraint.motion.mQuantizeMotionSteps);
                    break;
                case 85:
                    constraint.motion.mQuantizeMotionPhase = typedArray.getFloat(attr, constraint.motion.mQuantizeMotionPhase);
                    break;
                case 86:
                    TypedValue type = typedArray.peekValue(attr);
                    if (type.type != 1) {
                ...
                case 87:
                    ...
                    break;
                case 91:
                    constraint.layout.baselineToTop = lookupID(typedArray, attr, constraint.layout.baselineToTop);
                    break;
                case 92:
                    constraint.layout.baselineToBottom = lookupID(typedArray, attr, constraint.layout.baselineToBottom);
                    break;
                case 93:
                    constraint.layout.baselineMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.baselineMargin);
                    break;
                case 94:
                    constraint.layout.goneBaselineMargin = typedArray.getDimensionPixelSize(attr, constraint.layout.goneBaselineMargin);
                    break;
                case 95:
                    parseDimensionConstraints(constraint.layout, typedArray, attr, 0);
                    break;
                case 96:
                    parseDimensionConstraints(constraint.layout, typedArray, attr, 1);
                    break;
                case 97:
                    constraint.layout.mWrapBehavior = typedArray.getInt(attr, constraint.layout.mWrapBehavior);
                    break;
                default:
                    Log.w(TAG, "Unknown attribute 0x" + Integer.toHexString(attr) + "   " + mapToConstant.get(attr));
                    break;
    ...
    class WriteXmlEngine {
        ...
        private void writeBoolen(String dimString, boolean val, boolean def) throws IOException {
            if (val != def) {
                Writer writer2 = this.writer;
                writer2.write(SPACE + dimString + "=\"" + val + "dp\"");
            }
        }
        ...
        private void writeEnum(String dimString, int val, String[] types, int def) throws IOException {
            if (val != def) {
                Writer writer2 = this.writer;
                writer2.write(SPACE + dimString + "=\"" + types[val] + "\"");
            }
        }
        ...
        private void writeDimension(String dimString, int dim, int def) throws IOException {
            if (dim != def) {
                Writer writer2 = this.writer;
                writer2.write(SPACE + dimString + "=\"" + dim + "dp\"");
            }
        }
        ...
        private void writeBaseDimension(String dimString, int dim, int def) throws IOException {
            ...
            if (dim == -2) {
                Writer writer2 = this.writer;
                writer2.write(SPACE + dimString + "=\"wrap_content\"");
            } else if (dim == -1) {
                Writer writer3 = this.writer;
                writer3.write(SPACE + dimString + "=\"match_parent\"");
            } else {
                Writer writer4 = this.writer;
                writer4.write(SPACE + dimString + "=\"" + dim + "dp\"");
            }
        }
        ...
        public void writeXmlConstraint(String str, int leftToLeft) throws IOException {
            if (leftToLeft != -1) {
                ...
                Writer writer3 = this.writer;
                writer3.write("=\"" + getName(leftToLeft) + "\"");
            }
        }
        ...
        public void writeCircle(int circleConstraint, float circleAngle, int circleRadius) throws IOException {
            if (circleConstraint != -1) {
                ...
                Writer writer2 = this.writer;
                writer2.write(", " + circleAngle);
                Writer writer3 = this.writer;
                writer3.write(circleRadius + "]");
            }
        }
        ...
        public void writeVariable(String name, int value) throws IOException {
            if (value != 0 && value != -1) {
                Writer writer2 = this.writer;
                writer2.write(SPACE + name + "=\"" + value + "\"\n");
            }
        }
            ...
            if (dim == 0) {
                if (dimMax == -1 && dimMin == -1) {
                    switch (dimDefault) {
                        case 1:
                            Writer writer2 = this.writer;
                            writer2.write(SPACE + dimString + ": '???????????',\n");
                            return;
                        case 2:
                            Writer writer3 = this.writer;
                            writer3.write(SPACE + dimString + ": '" + dimPercent + "%',\n");
                            return;
                        default:
                            return;
                    }
                    ...
                    switch (dimDefault) {
                        case 0:
                            Writer writer4 = this.writer;
                            writer4.write(SPACE + dimString + ": {'spread' ," + dimMin + ", " + dimMax + "}\n");
                            return;
                        case 1:
                            Writer writer5 = this.writer;
                            writer5.write(SPACE + dimString + ": {'wrap' ," + dimMin + ", " + dimMax + "}\n");
                            return;
                        case 2:
                            Writer writer6 = this.writer;
                            writer6.write(SPACE + dimString + ": {'" + dimPercent + "'% ," + dimMin + ", " + dimMax + "}\n");
                            return;
                        default:
                            return;
                    }
                ...
                writer7.write(SPACE + dimString + ": 'wrap'\n");
            } else if (dim == -1) {
                Writer writer8 = this.writer;
                writer8.write(SPACE + dimString + ": 'parent'\n");
            } else {
                Writer writer9 = this.writer;
                writer9.write(SPACE + dimString + ": " + dim + ",\n");
            }
        }
