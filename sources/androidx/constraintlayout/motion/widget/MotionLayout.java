    ...
    class Model {
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            if (child.mTop.mTarget != null) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append("T");
                sb2.append(child.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? "T" : str5);
                str2 = sb2.toString();
            } else {
                str2 = str6;
            }
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                sb.append("");
                String str2 = "_";
                sb.append(child.mTop.mTarget != null ? "T" : str2);
                String a = sb.toString();
                StringBuilder sb2 = new StringBuilder();
                sb2.append(a);
        ...
        if (this.mKeepAnimating || (this.mInTransition && (force || this.mTransitionGoalPosition != f))) {
            ...
            if (interpolator == null || done) {
                ...
                if (interpolator2 == stopLogic) {
                    stopLogicDone3 = stopLogic.isStopped() ? 2 : 1;
                } else {
                    stopLogicDone3 = false;
                }
                ...
                if (interpolator3 instanceof MotionInterpolator) {
                    ...
                    if (Math.abs(lastVelocity) * this.mTransitionDuration <= EPSILON && stopLogicDone3 == 2) {
                        this.mInTransition = false;
                    }
