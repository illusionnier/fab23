...
public class ViewTransition {
    ...
    ViewTransition(android.content.Context r9, org.xmlpull.v1.XmlPullParser r10) {
        ...
        L_0x0036:
            ...
            return
        L_0x0041:
            java.lang.String r7 = r10.getName()     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
            r2 = r7
            int r7 = r2.hashCode()     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
            switch(r7) {
        ...
        L_0x004e:
            ...
            boolean r5 = r2.equals(r5)     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
        ...
        L_0x0058:
            ...
            goto L_0x007e
        L_0x0062:
            boolean r5 = r2.equals(r6)     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
            if (r5 == 0) goto L_0x004d
            r5 = r1
            goto L_0x007e
        L_0x006a:
            java.lang.String r6 = "KeyFrameSet"
            boolean r6 = r2.equals(r6)     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
        ...
        L_0x0081:
            java.lang.String r5 = TAG     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
            goto L_0x009f
        L_0x0084:
        ...
        L_0x009b:
            ...
            goto L_0x00d4
        L_0x009f:
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
            r6.<init>()     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
            ...
            r6.append(r7)     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
            java.lang.String r7 = " unknown tag "
            r6.append(r7)     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
            r6.append(r2)     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
            java.lang.String r6 = r6.toString()     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
            android.util.Log.e(r5, r6)     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
            java.lang.String r5 = TAG     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
            r6.<init>()     // Catch:{ XmlPullParserException -> 0x00e3, IOException -> 0x00de }
    ...
    public void applyTransition(ViewTransitionController controller, MotionLayout layout, int fromId, ConstraintSet current, View... views) {
        ...
        if (!this.mDisabled) {
                ...
                while (i4 < ids.length) {
                    ...
                    if (id != i) {
                        ...
                        for (int i5 = i3; i5 < length; i5++) {
                            ConstraintSet.Constraint constraint = cSet.getConstraint(viewArr[i5].getId());
            ...
            for (View view : viewArr) {
                ConstraintSet.Constraint constraint3 = transformedState.getConstraint(view.getId());
    ...
    public /* synthetic */ void m1lambda$applyTransition$0$androidxconstraintlayoutmotionwidgetViewTransition(View[] views) {
        if (this.mSetsTag != -1) {
            for (View view : views) {
