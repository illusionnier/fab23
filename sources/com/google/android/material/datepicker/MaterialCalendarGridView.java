                ...
                if (!skipMonth(firstOfMonth, lastOfMonth, Long.valueOf(startItem), Long.valueOf(endItem))) {
                    ...
                    if (endItem > lastOfMonth.longValue()) {
                        ...
                        if (monthAdapter.isLastInRow(lastHighlightPosition) != 0) {
                            ...
                            rangeHighlightEnd = materialCalendarGridView.getChildAtPosition(lastHighlightPosition).getRight();
                        } else {
                            rangeHighlightEnd = materialCalendarGridView.getChildAtPosition(lastHighlightPosition).getLeft();
                        }
                        ...
                        rangeHighlightEnd = horizontalMidPoint(materialCalendarGridView.getChildAtPosition(lastHighlightPosition));
                    }
                    ...
                    while (row <= lastRow) {
                        ...
                        int lastHighlightPosition2 = lastHighlightPosition;
                        int right = i;
                        int i5 = lastPositionInRow;
                        int i6 = firstPositionInRow2;
                        int i7 = top;
                        int i8 = right;
                        int i9 = bottom;
                        canvas.drawRect((float) firstPositionInRow2, (float) top, (float) right, (float) bottom, calendarStyle.rangeFill);
                        row++;
                        materialCalendarGridView = this;
                        monthAdapter = monthAdapter2;
                        firstRow = firstRow2;
                        lastHighlightPosition = lastHighlightPosition2;
                        lastRow = lastRow2;
                    }
                    int i10 = lastHighlightPosition;
                    int i11 = firstRow;
                    int i12 = lastRow;
                    materialCalendarGridView = this;
